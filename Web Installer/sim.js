...
async function reloadMap() {
    const url = !isProd && OPTIONS.dev ? `http://127.0.0.1:3001/hki-ltm/${OPTIONS.apiVersion}.json?mode=${mode}` : `https://84.250.190.107:3001/hki-ltm/${OPTIONS.apiVersion}.json?mode=${mode}`
    const response = await fetch(url)
